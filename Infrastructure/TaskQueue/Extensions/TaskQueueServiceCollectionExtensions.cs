...
using HelpMe.Infrastructure.TaskQueue.Builders;
using HelpMe.Infrastructure.TaskQueue.Dependencies;
using HelpMe.Infrastructure.TaskQueue.HostedServices;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;

namespace HelpMe.Infrastructure.TaskQueue.Extensions;
...
public static class TaskQueueServiceCollectionExtensions
{
    ...
    private static IServiceCollection AddInternalService(this IServiceCollection services, TaskQueueOptionsBuilder taskQueueOptionsBuilder)
    {
        ...
        {
            // 创建后台队列实例
            return new Dependencies.TaskQueue(taskQueueOptionsBuilder.ChannelCapacity);
        });
