...
namespace HelpMe.Infrastructure.HttpRemote;
...
public sealed partial class HttpRequestBuilder
{
    ...
    /// </summary>
    /// <remarks>
    ///     该操作将强制覆盖 <see cref="SetContent" />、<see cref="SetContentEncoding(Encoding)" /> 和
    ...
    public HttpRequestBuilder SuppressExceptions(Type[] exceptionTypes)
    {
        ...
        if (exceptionTypes.Any(u => u is null || !typeof(Exception).IsAssignableFrom(u)))
        {
            throw new ArgumentException(
